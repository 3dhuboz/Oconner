        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              {techLocations.length} tech{techLocations.length !== 1 ? 's' : ''} online &bull; {activeJobs.length} active job{activeJobs.length !== 1 ? 's' : ''} &bull; Updated {format(lastRefresh, 'h:mm:ss a')}
            </p>
          </div>
        </div>
