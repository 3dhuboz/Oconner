        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl w-full max-w-lg p-6 my-8">
            ...
            <div className="space-y-4">
              ...
              {/* Delivery Zones */}
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider pt-2">Delivery Zones</p>
              <ZoneAutocomplete value={editForm.zones} onChange={(v) => setEditForm((f) => ({ ...f, zones: v }))} label="Assigned Areas" hint="Search for suburbs to add delivery zones for this driver." />
            </div>
